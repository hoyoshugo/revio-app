    ...
    <div className="max-w-lg space-y-4">
      <div>
        ...
        <p className="text-sm mt-0.5" style={{ color: 'var(--text-2)' }}>
          Estado de tu suscripción, plan y facturas
        </p>
      </div>
      <BillingPanel />
    </div>
        ...
        >
          ...
          {!collapsed && (
            <div className="overflow-hidden">
              <div className="text-white font-bold text-lg leading-none tracking-tight">alzio</div>
          ...
          >
            ...
            {!collapsed && (
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[10px] capitalize" style={{ color: 'var(--text-3)' }}>
                  {user?.role}
                </div>
              </div>
            )}
        ...
        <div className="fixed inset-0 z-50 flex lg:hidden">
          ...
          <aside className="relative w-64 flex flex-col" style={{ background: 'var(--surface)' }}>
            ...
            >
              ...
              <div>
                <div className="text-white font-bold text-lg leading-none">alzio</div>
                <div className="text-white/70 text-[10px] uppercase tracking-wider mt-0.5">
                  Agente de ventas IA
                </div>
              </div>
          ...
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              <Route
                path="/gantt"
                element={
                  <RequireModule moduleId="pms">
                    <GanttCalendar property={property} />
                  </RequireModule>
                }
              />
              <Route
                ...
                element={
                  <RequireModule moduleId="pms">
                    <RoomsManager property={property} />
                  </RequireModule>
                }
              />
              ...
              <Route
                ...
                element={
                  <RequireModule moduleId="pms">
                    <HousekeepingBoard property={property} />
                  </RequireModule>
                }
              />
              ...
              <Route
                path="/pos"
                element={
                  <RequireModule moduleId="nfc_pos">
                    <POSTerminal property={property} />
                  </RequireModule>
                }
              />
              <Route
              ...
              <Route
                path="/property-knowledge/advanced"
                element={<PropertyKnowledgePanel propertyId={property?.id} />}
              />
              <Route path="/escalations" element={<EscalationsPage />} />
              <Route
                path="/escalations/legacy"
                element={<EscalationsPanel property={property} />}
              />
              ...
              <Route
                path="/channels"
                element={
                  <RequireModule moduleId="channel_manager">
                    <ChannelManager />
                  </RequireModule>
                }
              />
